        ...
        <div className='pb-3'>
            <div className='flex w-full items-center mx-2'>
                ...
                <div className='w-[30%] text-black text-justify'>
                    ...
                    <p className='text-black text-sm'>UID:</p>
                    <p className='text-black text-sm'>256160</p>
                    <p className='text-black text-sm'>Unverified</p>
                </div>
            </div>
            <div>
            ...
            <div className="px-6 py-2 text-black mt-10">
                <ul>
                    <li className='mb-3'>
                        <div className="flex justify-between items-center gap-5">
                            <div className='flex justify-center items-center gap-3'>
                                <button><FaHeadphonesAlt style={{ fontSize: "20px", color: "black" }} /></button>
                    ...
                    <li className='mb-3'>
                        <div className="flex justify-between items-center gap-5">
                            <div className='flex justify-center items-center gap-3'>
                                <button><FaUser style={{ fontSize: "20px", color: "black" }} /></button>
                                <div className="space-y-1">
                    ...
                    <li className='mb-3'>
                        <div className="flex justify-between items-center gap-5">
                            <div className='flex justify-center items-center gap-3'>
                                <button><FaLock style={{ fontSize: "20px", color: "black" }} /></button>
                                <div className="space-y-1">
                    ...
                    <li className='mb-3'>
                        <div className="flex justify-between items-center gap-5">
                            <div className='flex justify-center items-center gap-3'>
                                <button><img src={noty} alt="" style={{ height: 24, backgroundColor: "black" }} /></button>
                                <div className="space-y-1">
                    ...
                    <li className='mb-3'>
                        <div className="flex justify-between items-center gap-5">
                            <div className='flex justify-center items-center gap-3'>
                                <button><FaQuestionCircle style={{ fontSize: "20px", color: "black" }} /></button>
                                <div className="space-y-1">
                                    <h3 className="text-md">Support</h3>
                                </div>
                            </div>
            ...
            <div className='flex justify-center mt-3'>
                <div className='text-black p-5 mt-5 rounded-2xl items-center'>
                    ...
                    <p><button className='text-black text-md px-2'>https://t.me/tbzsupport</button></p>
                </div>
            </div>
            <div className='flex justify-center'>
            ...
            <Link className='bg-[#15C7A7] rounded-xl block text-center text-black py-2 mx-14 hover:bg-[#96bff1] mt-6 mb-2'>Logout</Link>
        </div>
    );
};
